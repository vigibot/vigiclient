...
#define CONFIDENCEMAXVELOCITY 32
#define CONFIDENCEMAXTILT (2.0 * M_PI / 180.0)
#define CONFIDENCEDELAY 10
#define CONFIDENCEDISTERROR 50
#define CONFIDENCEANGULARERROR (5.0 * M_PI / 180.0)

#define ODOMETRYCORRECTORDIV 4
#define IMUTHETACORRECTORDIV 20
