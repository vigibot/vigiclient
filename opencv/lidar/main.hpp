...
#define SMALLDISTTOLERANCE 50
#define SMALLANGULARTOLERANCE (5.0 * M_PI / 180.0)

#define CONFIDENCEDISTTOLERANCE 30
#define CONFIDENCEANGULARTOLERANCE (3.0 * M_PI / 180.0)
